...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <section className="py-24 bg-white" data-aos="fade-up">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Jesteśmy platformą łączącą specjalistów i klientów. Naszą misją jest
            ułatwienie procesu wyszukiwania i zamawiania usług. Z nami
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow p-8">
              <h3 className="text-xl font-bold text-emerald-700 mb-4">Basic</h3>
            ...
            <div className="bg-white rounded-xl shadow p-8 border-t-4 border-emerald-500">
              ...
              <ul className="text-gray-600 space-y-2 mb-8">
                ...
                <li className="flex items-center justify-center gap-2">
                  <FaCheck className="text-emerald-500" /> Priorytetowe wsparcie
                </li>
                <li className="flex items-center justify-center gap-2">
                  <FaCheck className="text-emerald-500" /> Gwarancja satysfakcji
                </li>
              </ul>
              <button className="px-6 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full font-medium transition">
                Wybierz
      ...
      {/* CTA SECTION */}
      <section className="py-24 bg-emerald-100 text-center" data-aos="fade-up">
